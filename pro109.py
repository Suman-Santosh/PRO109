...
print("{}% of data lies between three standard deviation".format(len(list_of_data_3)*100.0/len(reading_list)))
...
fig.add_trace(go.Scatter(x = [first_std_deviation_start,first_std_deviation_start] , y = [0,0.02] , mode = "lines" , name = "1 stdev start"))
fig.add_trace(go.Scatter(x = [first_std_deviation_end,first_std_deviation_end] , y = [0,0.02] , mode = "lines" , name = "1 stdev end"))

fig.add_trace(go.Scatter(x = [second_std_deviation_start,second_std_deviation_start] , y = [0,0.02] , mode = "lines" , name = "2 stdev start"))
fig.add_trace(go.Scatter(x = [second_std_deviation_end,second_std_deviation_end] , y = [0,0.02] , mode = "lines" , name = "2 stdev end"))

fig.add_trace(go.Scatter(x = [third_std_deviation_start,third_std_deviation_start] , y = [0,0.02] , mode = "lines" , name = "3 stdev start"))
fig.add_trace(go.Scatter(x = [third_std_deviation_end,third_std_deviation_end] , y = [0,0.02] , mode = "lines" , name = "3 stdev end"))
fig.show()